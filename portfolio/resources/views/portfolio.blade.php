...
@section('content')
	<div id="main" class="page-portfolio container-fluid"> 
<?php
	/*		Portfolio Page
	 *	
	 *
...
?>
<div id="prompton-banner" class="container-fluid img-banner banner"> 
<cite>Photo Credit: Josh Rogan - June. 2014</cite>
</div>
...
<section class="container" id="content"> 
	...
	<h2> Websites </h2>
	<!-- <p> Here are a few examples of websites that I am currently working on. </p> -->
				...
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							...
							<a href="https://github.com/JoshuaRogan/genetics" target="_blank" class="btn btn-primary" role="button"><i class="fa fa-github"></i></a>
						</p>
		...
		<div data-sr class="row"> 
			<div class="col-md-4">
				<div class="thumbnail">
					<img src="/images/portfolio/unico.jpg"  alt="unico logo">
					<div class="caption">
						<h3>Unico Website*</h3>
						<p>Developed a informational website for a non-profit chapter organization <a href="http://www.unico.org/" target="_blank">UNICO</a>. Built using bootstrap. </p>
						<p><a href="http://unico.jcubedworld.com/" target="_blank" class="btn btn-primary" role="button">Live</a> <!-- <a href="#" class="btn btn-default" role="button"><i class="fa fa-cloud-download"></i></a> --></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
